...
<h1>Reservation Salle Claude Francois</h1>
<form>
  <!-- <fieldset>
       14 <legend>Information personnel</legend>
        ...
        <div class="double-input">
            <div class="form-input-container">
                ...
                <select name="salle" id="salle">
                    <option value="CF">Claude Francois</option>
                </select>
            </div>
            <div class="form-input-container">
                <label for="capacity">Nombre de personnes</label>
                <input type="number" name="capacity" id="capacity" value="1" min="1" max="12" step="1" />
            </div>
        </div>
        <div class="double-input">
