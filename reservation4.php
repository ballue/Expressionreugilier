...
<h1>Reservation Salle Patrick Sebastien</h1>
<form>
    <!--<fieldset>
        ...
        <div class="double-input">
            <div class="form-input-container">
                ...
                <select name="salle" id="salle">
                    <option value="ps">Patrick Sebastien</option>

                </select>
            </div>
            <div class="form-input-container">
                <label for="capacity">Nombre de personnes</label>
                <input type="number" name="capacity" id="capacity" value="1" min="1" max="35" step="1" />
            </div>
        </div>
        <div class="double-input">
    ...
    <?php
    include_once ('../include/reserve.php.php');
    ?>hp';